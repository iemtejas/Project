...
var qAnswers = ["I have no name!", "I don't need any place to live.", "I am a male robot.", "I don't take any meal.", "I love python though I am not programmed in Python.", "Of course I love.", "A robot never reads any book!", "Not yet..", "Of course my creator- Tejas Sharma.", "Probably all.", "Showing all of my teeth..!!"];
var dist = 0;
...
function reply(msg) {
...
else if (msg.startsWith("wow")) {
        var reps = ["I know its amazing"];
    ...
    else if (msg.startsWith("sex?")) {
        var reps = ["With your mom? yeah sure 👀"];
        sendMsg(reps[Math.floor(Math.random() * reps.length)]);
    }
    ...
    else if(containsWord(msg,"sorry") && (containsWord("i") || wordNum(msg)<=3))
    {
        ...
        var possAns=["Pardon me?","I am just a bot bro, don't say anything I can't understand.","sorry?."]
